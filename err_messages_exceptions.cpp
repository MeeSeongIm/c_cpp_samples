// constructing error messages with exceptions
...
class E : public exception {
	const char * msg;
	E(){}; 				// private scope: disallows the default constructor
public:
	E(const char * s) throw() : msg(s) {}  // not allowing any exceptions to be thrown from inside this function
